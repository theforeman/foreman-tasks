...
import { ClickConfirmation, UnlockModal, ForceUnlockModal } from './';
...
describe('ClickConfirmation', () => {
  ...
  describe('Modal Close Behavior', () => {
    it('resets checkbox state when modal is closed via confirm', () => {
      const onClick = jest.fn();
      const setModalClosed = jest.fn();
...
describe('ForceUnlockModal', () => {
  ...
  it('renders with correct force unlock-specific content and danger variant', () => {
    render(<ForceUnlockModal {...defaultProps} />);
  ...
  it('displays correct number of tasks in body', () => {
    render(<ForceUnlockModal {...defaultProps} selectedRowsLen={5} />);
