...
describe('TaskInfo', () => {
  ...
  it('expands to show label, execution type, start at, ended at, and external id', () => {
    render(
      <TaskInfo
        id="tid"
  ...
  it('reports delayed execution type when startAt and startedAt differ', () => {
    render(
      <TaskInfo
        id=""
        state="stopped"
  ...
  it('formats stop duration when started and ended are valid', () => {
    render(
      <TaskInfo
        ...
        endedAt="2020-01-01T10:00:45.000Z"
      />
    );
